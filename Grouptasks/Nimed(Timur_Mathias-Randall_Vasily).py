...
def draw_S(x,y): # S
    ...
    draw_block(x+10, y, 30, 10, "rectang", 0)

def draw_A(x,y): # A
    draw_block(x+60,y-30, 10, 20, "split_circle_h_neg", 30)
    draw_block(x, y-30, 10, 40, "rectang", 0)
    draw_block(x+50, y-30, 10, 40, "rectang", 0)
    draw_block(x, y-40, 60, 10, "rectang", 0)

def draw_H(x,y): # H
    draw_block(x, y, 10, 70, "rectang", 0)
    draw_block(x+50, y, 10, 70, "rectang", 0)
    draw_block(x, y-30, 50, 10, "rectang", 0)

def draw_N(x,y): # N
    draw_block(x, y, 40, 70, "slope", 0)
    draw_block(x+40, y, 10, 70, "rectang", 0)
    draw_block(x, y, 10, 70, "rectang", 0)

def draw_D(x,y): # D
    draw_block(x+10, y-70, 10, 0, "split_circle_w", 35)
    draw_block(x, y, 10, 70, "rectang", 0)
    
def draw_L(x,y): # L
    draw_block(x, y, 10, 70, "rectang", 0)
    draw_block(x, y-60, 40, 10, "rectang", 0)

def draw_V(x,y): #V
    draw_block(x, y, 30, 70, "slope", 0)
    draw_block(x+30, y, 30, 70, "neg-slope", 0)

def draw_Y(x,y): #Y
    draw_block(x, y, 30, 35, "slope", 0)
    draw_block(x+30, y, 30, 35, "neg-slope", 0)
    draw_block(x+30 ,y-35, 10, 35, "rectang", 0)

def draw_slash(x,y): # slash
    draw_block(x-40, y-30, 30, 10, "rectang", 0)
...
def draw_name_MATHIAS():
    start_x = -500
    y = 150
    spacing = 50
    draw_M(start_x, y)
    draw_A(start_x + 30 + spacing*1, y)
    draw_T(start_x + 50 + spacing*2, y)
    draw_H(start_x + 80 + spacing*3, y)
    draw_I(start_x + 90 + spacing*4, y)
    draw_A(start_x + 90 + spacing*5, y)
    draw_S(start_x + 120 + spacing*6, y)
    draw_slash(start_x + 170 + spacing*7, y)
    draw_R(start_x + 130 + spacing*8, y)
    draw_A(start_x + 150 + spacing*9, y)
    draw_N(start_x + 180 + spacing*10, y)
    draw_D(start_x + 200 + spacing*11, y)
    draw_A(start_x + 210 + spacing*12, y)
    draw_L(start_x + 240 + spacing*13, y)
    draw_L(start_x + 250 + spacing*14, y)

draw_name_MATHIAS()

def draw_name_VASILY():
    start_x = -200
    y = -50
    spacing = 50
    draw_V(start_x, y)
    draw_A(start_x + 15 + spacing*1, y)
    draw_S(start_x + 40 + spacing*2, y)
    draw_I(start_x + 40 + spacing*3, y)
    draw_L(start_x + 45 + spacing*4, y)
    draw_Y(start_x + 35 + spacing*5, y)
